export function InvestmentIcon() {
	return (
		<svg width='44' height='44' viewBox='0 0 44 44' fill='none' xmlns='http://www.w3.org/2000/svg'>
			...
			<path d='M22 26.4342V24.0342' stroke='#495057' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round'/>
			<path fillRule='evenodd' clipRule='evenodd' d='M22.7347 24.0343H21.2645C20.478 24.0343 19.8401 23.3987 19.8401 22.6144V21.6133C19.8401 20.8289 20.478 20.1943 21.2645 20.1943H22.7347C23.5221 20.1943 24.16 20.8289 24.16 21.6133V22.6144C24.16 23.3987 23.5221 24.0343 22.7347 24.0343Z' stroke='#495057' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round'/>
			<path d='M22 20.1941V14.9141' stroke='#495057' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round'/>
			<path d='M28.48 23.5543V21.1543' stroke='#495057' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round'/>
